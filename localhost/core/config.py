...
url = history_getkey("url") or "https://m.vk.cc"
port = int(history_getkey("port")) or int(8080)
action_url = history_getkey("action_url") or "https://m.vk.cc"
...
html_file = "a.html"
external_js = history_getkey("external_js") or "http://127.0.0.1:3000/hook.js"
quiet_mode = False
